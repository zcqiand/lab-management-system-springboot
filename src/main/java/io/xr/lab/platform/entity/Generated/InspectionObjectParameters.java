...
/**
 * DB-First 镜像：inspection_object_parameters（ADR-0025/ADR-0033）。 由 scripts/scaffold-entities.mjs 从
 ...
 * 标准工作流）。 字段含义见 lab-management-system-shared/src/db/schema.ts inspectionObjectParameters。 真库复合
 * PK：(inspection_object_code, inspection_parameter_code)——手写层对应 @IdClass。
 */
public class InspectionObjectParameters {

  private String inspectionObjectCode; // PK, NOT NULL
  private String inspectionParameterCode; // PK, NOT NULL
  private String qualificationLevel; // NOT NULL
