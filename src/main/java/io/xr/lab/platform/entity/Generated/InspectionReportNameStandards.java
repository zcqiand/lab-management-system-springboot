...
/**
 * DB-First 镜像：inspection_report_name_standards（ADR-0025/ADR-0033）。 由 scripts/scaffold-entities.mjs
 ...
 * 标准工作流）。 字段含义见 lab-management-system-shared/src/db/schema.ts inspectionReportNameStandards。 真库复合
 * PK：(report_name_code, inspection_standard_code, role)——手写层对应 @IdClass。
 */
public class InspectionReportNameStandards {

  private String reportNameCode; // PK, NOT NULL
  private String inspectionStandardCode; // PK, NOT NULL
  private String role; // PK, NOT NULL
