...
/**
 * DB-First 镜像：inspection_specialty_objects（ADR-0025/ADR-0033）。 由 scripts/scaffold-entities.mjs 从
 ...
 * 标准工作流）。 字段含义见 lab-management-system-shared/src/db/schema.ts inspectionSpecialtyObjects。 真库复合
 * PK：(inspection_specialty_code, inspection_object_code)——手写层对应 @IdClass。
 */
public class InspectionSpecialtyObjects {

  private String inspectionSpecialtyCode; // PK, NOT NULL
