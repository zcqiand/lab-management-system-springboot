...
/**
 * DB-First 镜像：inspection_standards（ADR-0025/ADR-0033）。 由 scripts/scaffold-entities.mjs 从 lab_dev
 ...
 * 标准工作流）。 字段含义见 lab-management-system-shared/src/db/schema.ts inspectionStandards。
 */
