...
/**
 * DB-First 镜像：inspection_object_parameters 复合 PK（ADR-0025/ADR-0033）。 由
 * scripts/scaffold-entities.mjs 从 lab_dev 真库反推生成——纯 POJO 镜像， 手写层 @IdClass 见
 * io.xr.lab.platform.entity。
 */
public class InspectionObjectParametersId implements Serializable {
  ...
  public InspectionObjectParametersId() {}

  public InspectionObjectParametersId(String inspectionObjectCode, String inspectionParameterCode) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof InspectionObjectParametersId)) return false;
    InspectionObjectParametersId that = (InspectionObjectParametersId) o;
