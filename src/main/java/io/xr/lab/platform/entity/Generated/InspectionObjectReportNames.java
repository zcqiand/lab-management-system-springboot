...
/**
 * DB-First 镜像：inspection_object_report_names（ADR-0025/ADR-0033）。 由 scripts/scaffold-entities.mjs 从
 ...
 * 标准工作流）。 字段含义见 lab-management-system-shared/src/db/schema.ts inspectionObjectReportNames。 真库复合
 * PK：(inspection_object_code, report_name_code)——手写层对应 @IdClass。
 */
public class InspectionObjectReportNames {
