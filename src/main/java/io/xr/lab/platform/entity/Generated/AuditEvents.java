...
/**
 * DB-First 镜像：audit_events（ADR-0025/ADR-0033）。 由 scripts/scaffold-entities.mjs 从 lab_dev
 ...
 * 标准工作流）。 字段含义见 lab-management-system-shared/src/db/schema.ts auditEvents。
 */
public class AuditEvents {

  private String id; // PK, NOT NULL
  private String action; // NOT NULL, enum audit_action
  private String operator; // NOT NULL
  private String target; // NOT NULL
  private String targetId;
  private String detail;
  private String ip;
  private String at; // NOT NULL
