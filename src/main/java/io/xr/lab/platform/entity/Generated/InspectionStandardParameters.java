...
/**
 * DB-First 镜像：inspection_standard_parameters（ADR-0025/ADR-0033）。 由 scripts/scaffold-entities.mjs 从
 ...
 * 标准工作流）。 字段含义见 lab-management-system-shared/src/db/schema.ts inspectionStandardParameters。 真库复合
 * PK：(inspection_standard_code, inspection_parameter_code)——手写层对应 @IdClass。
 */
public class InspectionStandardParameters {
