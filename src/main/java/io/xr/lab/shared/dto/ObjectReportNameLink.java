...
public class ObjectReportNameLink {
  ...
  public ObjectReportNameLink() {
    super();
  }

  /** Constructor with only required parameters */
  public ObjectReportNameLink(String inspectionObjectCode, String reportNameCode) {
    this.inspectionObjectCode = inspectionObjectCode;
    this.reportNameCode = reportNameCode;
  }

  public ObjectReportNameLink inspectionObjectCode(String inspectionObjectCode) {
    this.inspectionObjectCode = inspectionObjectCode;
    return this;
  }
  ...
  public ObjectReportNameLink reportNameCode(String reportNameCode) {
    this.reportNameCode = reportNameCode;
    return this;
  }
  ...
  public ObjectReportNameLink remark(@Nullable String remark) {
    this.remark = remark;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ObjectReportNameLink objectReportNameLink = (ObjectReportNameLink) o;
    return Objects.equals(this.inspectionObjectCode, objectReportNameLink.inspectionObjectCode)
        && Objects.equals(this.reportNameCode, objectReportNameLink.reportNameCode)
        && Objects.equals(this.remark, objectReportNameLink.remark);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inspectionObjectCode, reportNameCode, remark);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ObjectReportNameLink {\n");
