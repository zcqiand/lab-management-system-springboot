...
public class UpdateTechnicalRequirementRequest {
  ...
  public UpdateTechnicalRequirementRequest conditions(@Nullable String conditions) {
  ...
  public UpdateTechnicalRequirementRequest valueType(@Nullable RequirementValueType valueType) {
  ...
  public UpdateTechnicalRequirementRequest minValue(@Nullable Integer minValue) {
  ...
  public UpdateTechnicalRequirementRequest maxValue(@Nullable Integer maxValue) {
  ...
  public UpdateTechnicalRequirementRequest targetValue(@Nullable String targetValue) {
  ...
  public UpdateTechnicalRequirementRequest expression(@Nullable String expression) {
  ...
  public UpdateTechnicalRequirementRequest unit(@Nullable String unit) {
    this.unit = unit;
    return this;
  }
  ...
  public UpdateTechnicalRequirementRequest comparison(@Nullable RequirementComparison comparison) {
  ...
  public UpdateTechnicalRequirementRequest judgmentMode(
  ...
  public UpdateTechnicalRequirementRequest verificationStatus(
  ...
  public UpdateTechnicalRequirementRequest clause(@Nullable String clause) {
    this.clause = clause;
    return this;
  }
  ...
  public UpdateTechnicalRequirementRequest sourcePage(@Nullable Integer sourcePage) {
  ...
  public UpdateTechnicalRequirementRequest sourceHash(@Nullable String sourceHash) {
  ...
  public UpdateTechnicalRequirementRequest brand(@Nullable String brand) {
    this.brand = brand;
    return this;
  }
  ...
  public UpdateTechnicalRequirementRequest model(@Nullable String model) {
    this.model = model;
    return this;
  }
  ...
  public UpdateTechnicalRequirementRequest grade(@Nullable String grade) {
    this.grade = grade;
    return this;
  }
  ...
  public UpdateTechnicalRequirementRequest spec(@Nullable String spec) {
    this.spec = spec;
    return this;
  }
  ...
  public UpdateTechnicalRequirementRequest sieve(@Nullable String sieve) {
    this.sieve = sieve;
    return this;
  }
  ...
  public UpdateTechnicalRequirementRequest remark(@Nullable String remark) {
    this.remark = remark;
    return this;
  }
  ...
  public UpdateTechnicalRequirementRequest sortOrder(@Nullable Integer sortOrder) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateTechnicalRequirementRequest updateTechnicalRequirementRequest =
        (UpdateTechnicalRequirementRequest) o;
    return Objects.equals(this.conditions, updateTechnicalRequirementRequest.conditions)
        && Objects.equals(this.valueType, updateTechnicalRequirementRequest.valueType)
        && Objects.equals(this.minValue, updateTechnicalRequirementRequest.minValue)
        && Objects.equals(this.maxValue, updateTechnicalRequirementRequest.maxValue)
        && Objects.equals(this.targetValue, updateTechnicalRequirementRequest.targetValue)
        && Objects.equals(this.expression, updateTechnicalRequirementRequest.expression)
        && Objects.equals(this.unit, updateTechnicalRequirementRequest.unit)
        && Objects.equals(this.comparison, updateTechnicalRequirementRequest.comparison)
        && Objects.equals(this.judgmentMode, updateTechnicalRequirementRequest.judgmentMode)
        && Objects.equals(
            this.verificationStatus, updateTechnicalRequirementRequest.verificationStatus)
        && Objects.equals(this.clause, updateTechnicalRequirementRequest.clause)
        && Objects.equals(this.sourcePage, updateTechnicalRequirementRequest.sourcePage)
        && Objects.equals(this.sourceHash, updateTechnicalRequirementRequest.sourceHash)
        && Objects.equals(this.brand, updateTechnicalRequirementRequest.brand)
        && Objects.equals(this.model, updateTechnicalRequirementRequest.model)
        && Objects.equals(this.grade, updateTechnicalRequirementRequest.grade)
        && Objects.equals(this.spec, updateTechnicalRequirementRequest.spec)
        && Objects.equals(this.sieve, updateTechnicalRequirementRequest.sieve)
        && Objects.equals(this.remark, updateTechnicalRequirementRequest.remark)
        && Objects.equals(this.sortOrder, updateTechnicalRequirementRequest.sortOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateTechnicalRequirementRequest {\n");
