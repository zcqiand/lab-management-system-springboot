...
public class InspectionSpec {
  ...
  public InspectionSpec code(String code) {
    this.code = code;
    return this;
  }
  ...
  public InspectionSpec tenantId(String tenantId) {
    this.tenantId = tenantId;
    return this;
  }
  ...
  public InspectionSpec inspectionObjectCode(@Nullable String inspectionObjectCode) {
  ...
  public InspectionSpec name(String name) {
    this.name = name;
    return this;
  }
  ...
  public InspectionSpec remark(@Nullable String remark) {
    this.remark = remark;
    return this;
  }
  ...
  public InspectionSpec sortOrder(Integer sortOrder) {
    this.sortOrder = sortOrder;
    return this;
  }
  ...
  public InspectionSpec createdAt(String createdAt) {
    this.createdAt = createdAt;
    return this;
  }
  ...
  public InspectionSpec updatedAt(String updatedAt) {
    this.updatedAt = updatedAt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InspectionSpec inspectionSpec = (InspectionSpec) o;
    return Objects.equals(this.code, inspectionSpec.code)
        && Objects.equals(this.tenantId, inspectionSpec.tenantId)
        && Objects.equals(this.inspectionObjectCode, inspectionSpec.inspectionObjectCode)
        && Objects.equals(this.name, inspectionSpec.name)
        && Objects.equals(this.remark, inspectionSpec.remark)
        && Objects.equals(this.sortOrder, inspectionSpec.sortOrder)
        && Objects.equals(this.createdAt, inspectionSpec.createdAt)
        && Objects.equals(this.updatedAt, inspectionSpec.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class InspectionSpec {\n");
