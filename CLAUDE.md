...
`java-spring` — Java 17 + Spring Boot 3.4 + Maven + JUnit5 + Spotless + SpotBugs
...
2. 最小改动
3. 在 **suite 根目录** 跑 `python scripts/gate.py -p lab-management-system-springboot`
